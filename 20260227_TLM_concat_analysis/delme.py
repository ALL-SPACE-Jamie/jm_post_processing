...
df2_path = r"C:\scratch\20260227\Portman-Gen2\dataframes\gain_table.csv"

tlm_list = ['QR420-0461-20092',
'QR420-0461-20028',
'QR420-0461-20068',
'QR420-0461-20123',
'QR420-0461-20078',
...
qr_second = tlm_list.copy() ######################
# Returns a Series of ranks aligned to qr_second (keeps the same order)
ranks = mean_ranks.reindex(qr_second)
# If you want a dict: {qr_code: rank}
ranks_dict = ranks.to_dict()
# Optionally, separate found/missing
found = ranks.dropna()
missing = [qr for qr, val in ranks.items() if pd.isna(val)]
