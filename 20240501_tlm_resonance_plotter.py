...
file_path = r'C:\Users\RyanFairclough\Downloads\Points_1001'
...
SaveFileName = '_Resonance_Data_Plot'
...
for beam in [1,2]:
    ...
    #fileName = 'Calibration'+ '_f-set' + str(f_set) + '_b' + str(beam) + '.png'
    #newPath = file_path + SaveFileName
